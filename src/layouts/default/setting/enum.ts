...
export const tabsTransitionOptions = [
  {
    value: TabsStyleEnum.BUTTON,
    label: t('layout.setting.tabsButton'),
  },
  {
    value: TabsStyleEnum.SMART,
    label: t('layout.setting.tabsSmart'),
  },
];
