  ...
  <PageWrapper title="Loading组件示例">
    ...
    >
      <n-space vertical :size="32">
        <n-alert type="info">组件方式</n-alert>
        <n-space>
          <n-button @click="compOpen()">component</n-button>
          <n-button @click="compOpen(true)">component(全屏)</n-button>
        </n-space>
        <n-alert type="info">函数方式</n-alert>
        <n-space>
          <n-button @click="fnOpen">全屏Loading</n-button>
          <n-button @click="fnOpen2">指定Element Loading</n-button>
        </n-space>
        <n-alert type="info">指令方式</n-alert>
        <n-button @click="directiveOpen">useDirctive</n-button>
      </n-space>
    </n-card>
