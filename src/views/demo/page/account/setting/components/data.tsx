...
export const SecureList = [
  ...
  {
    title: '备用邮箱',
    description: '已绑定邮箱: aso***mple.com',
  },
  {
    title: 'MFA 设备',
...
export const bindList = [
  {
    icon: <Icon icon="ant-design:taobao-outlined" />,
    iconColor: 'rgb(255, 64, 0)',
    title: '绑定淘宝',
    description: '当前未绑定淘宝账号',
  },
  {
    icon: <Icon icon="ion-logo-github" />,
    title: '绑定Github',
    description: '当前未绑定Github账号',
  },
  {
    icon: <Icon icon="ant-design:alipay-square-filled" />,
